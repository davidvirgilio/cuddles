...
export default function Page(){
    ...
    //             try{
    //                 const response = await fetch(`/api/mongodb/users/${user}`,{
    //                     cache: "no-store"
    //                 });
    ...
    <>
        <div className={`${style.profile} ${modalClose}`}>
            ...
            <div className={style.profilePic}>
                <Image alt={`${username}'s picture`} src={`https://s3.eu-west-3.amazonaws.com/cuddles.storage/${userData.profile_pic}`} width={100} height={100}/>
